            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  ...
                  <p>
                    Privacy Policy of https://prs.hcmutchain.net/
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="col-md-12">
                  <div className="content">
                    ...
                    <ul>
                      ...
                      <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Personal Response System.</p>
                      </li>
                      <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                      <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                      <li><strong>Website</strong> refers to Personal Response System, accessible from https://prs.hcmutchain.net/</li> <li><strong>Service</strong> refers to the Website.</li>
                      <li><strong>Country</strong> refers to: Viet Nam</li>
                      <li>
                    ...
                    <ul>
                      <li>By email: noreply.survey.hcmutchain@gmail.com</li>
                    </ul>
                  </div>
                </div>
              </div>
